...
const PartnersList = () => {
  ...
  const fetchPartners = async () => {
    try {
      ...
      const response = await fetch(
        `${backendUrl}/api/admin/partners?page=${currentPage}&limit=20&status=active&isActive=true`,
        {
          headers: {
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <div className="text-lg text-purple-600">Loading partners...</div>
      </div>
    );
  }
  ...
  return (
    <div className="container mx-auto p-6">
      ...
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-gray-800 mb-2">Partners List</h1>
            ...
            <CardHeader className="bg-linear-to-r from-purple-50 to-purple-100">
              <CardTitle className="flex items-center justify-between">
                <span className="text-lg font-semibold text-gray-800">
                  {partner.fullname.firstname} {partner.fullname.lastname}
                </span>
                <span
